  ...
  return (
    <div className="flex py-6 border-b">
      ...
      <div className="flex-1">
        ...
        <div className="mb-2">
          <span className="font-bold hoverunderline cursor-pointer">{username}</span>
        ...
        <div className="flex items-center text-sm mb-3">
          <FaMusic className="mr-2 text-sm" />
          <span className="truncate max-w-[250px]">{audio}</span>
        </div>

        <div className="flex">
          {/* Video container */}
          <div className="w-3 w-[300px] h-[530px] bg-black rounded-md flex items-center justify-center relative overflow-hidden">
            <p className="text-white">Video Placeholder</p>
            <div className="absolute bottom-4 left-4 text-white">
              <p className="mb-1">8:30</p>
            </div>
          </div>
        </div>
      </div>
